...
hip_burn_steps = 1000
hip_mcmc_steps = 10000

total_orbits = int(1e7)
burn_steps = int(5e6)
thin = 100
...
if __name__=="__main__":
    ...
    params = ['a$_{1}$ [au]','e$_{1}$','i$_{1}$ [rad]', '$\\omega_{0}$ [rad]', '$\\Omega_{0}$ [rad]','$\\tau_{1}$','$\\pi$ [mas]', '$\\mu_\\alpha$', '$\\mu_\\delta$', '$\\alpha_{0}$', '$\\delta_{0}$','M$_B$ [M$_{{\\odot}}$]','M$_A$ [M$_{{\\odot}}$]']
    import pandas as pd
